...
public class CatalogController(IMediator mediator) : ApiController
{
    ...
    [HttpGet]
    public async Task<ActionResult<Pagination<ProductResponse>>> GetAllProducts([FromQuery] GetAllProductsQuery request, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{brandName}")]
    public async Task<ActionResult<IEnumerable<ProductResponse>>> GetProductsByBrandName(string brandName, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{brandId}")]
    public async Task<ActionResult<IEnumerable<ProductResponse>>> GetProductsByBrandId(string brandId, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{typeName}")]
    public async Task<ActionResult<IEnumerable<ProductResponse>>> GetProductsByTypeName(string typeName, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{typeId}")]
    public async Task<ActionResult<IEnumerable<ProductResponse>>> GetProductsByTypeId(string typeId, CancellationToken cancellationToken)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<ProductBrandResponse>>> GetAllProductBrands(CancellationToken cancellationToken)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<ProductTypeResponse>>> GetAllProductTypes(CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<ProductResponse>> CreateProduct([FromBody] CreateProductCommand command, CancellationToken cancellationToken)
    {
