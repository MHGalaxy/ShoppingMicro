...
public class GetProductsByTypeIdQuery : IRequest<IEnumerable<ProductResponse>>
{
...
public class GetProductsByTypeIdQueryHandler(IProductRepository productRepository, IMapper mapper)
    : IRequestHandler<GetProductsByTypeIdQuery, IEnumerable<ProductResponse>>
{
    public async Task<IEnumerable<ProductResponse>> Handle(GetProductsByTypeIdQuery request, CancellationToken cancellationToken)
    {
